...
if isMonteCarlo
    ...
    maxSpeeds = ((25-5).*rand(10,1) + 5)'; % Between 5 and 25
    frontSensorRange = ((120-40).*rand(10,1) + 40)'; % Between 40 and 120
    AEBdistance = ((40-10).*rand(10,1) + 10)'; % Between 10 and 40
    minDeceleration = -((70-10).*rand(10,1) + 10)'; % Between -10 and -70
