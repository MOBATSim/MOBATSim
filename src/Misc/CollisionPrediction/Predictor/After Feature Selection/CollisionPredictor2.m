classdef CollisionPredictor2 < matlab.System & matlab.system.mixin.Propagates ...
    ...
    methods(Access = protected)
        ...
        function stepImpl(obj)
            load('t.mat');
            if get_param(obj.modelName,'SimulationTime') == t
                t = t + 1;          
                save t t
                load('Version3_2.mat');
                Data0 = cell2table(cell(0,8), 'VariableNames', {'maxSpeed_A', 'Speed_A','DistancetoCrosswaypoint_A','maxSpeed_B','Speed_B','DistancetoCrosswaypoint_B','A','B'});
                idx = 1;
                for i = 1:10
                    if (obj.Vehicles(i).pathInfo.currentRoute == 5 || obj.Vehicles(i).pathInfo.currentRoute == 46)&&  obj.Vehicles(i).dynamics.speed ~= 0 % crossway point 11
                        for k = 1:10
                            if (obj.Vehicles(k).pathInfo.currentRoute == 59 || obj.Vehicles(k).pathInfo.currentRoute == 12)...
                                ...
                                Data0(idx,:) = {maxSpeed_A,Speed_A,DistancetoCrosswaypoint_A,...
                                    maxSpeed_B,Speed_B,DistancetoCrosswaypoint_B,i,k};
                                idx = idx + 1;
                            end
                        end
                    elseif obj.Vehicles(i).pathInfo.currentRoute == 4 &&  obj.Vehicles(i).dynamics.speed ~= 0 %crossway point9A
                        for k = 1:10
                         ...
                         elseif obj.Vehicles(i).pathInfo.currentRoute == 47 &&  obj.Vehicles(i).dynamics.speed ~= 0 %crossway point9B
                        for k = 1:10
                            if ( obj.Vehicles(k).pathInfo.currentRoute == 82 || obj.Vehicles(k).pathInfo.currentRoute == 25)...
                                    &&  obj.Vehicles(k).dynamics.speed ~= 0
                                Speed_A = obj.Vehicles(i).dynamics.speed;
                                Position_A = obj.Vehicles(i).dynamics.position;
                                Speed_B = obj.Vehicles(k).dynamics.speed;
                    ...
                    elseif (obj.Vehicles(i).pathInfo.currentRoute == 20 || obj.Vehicles(i).pathInfo.currentRoute == 21)&&  obj.Vehicles(i).dynamics.speed ~= 0 %crossway point 44
                        for k = 1:10
                            if obj.Vehicles(k).pathInfo.currentRoute == 71 &&  obj.Vehicles(k).dynamics.speed ~= 0
                                ...
                                Position_B = obj.Vehicles(k).dynamics.position;
                                maxSpeed_A = obj.Vehicles(i).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_A = norm(Position_A - obj.Map.waypoints(44,:));
                                maxSpeed_B = obj.Vehicles(k).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_B = norm(Position_B - obj.Map.waypoints(44,:));
                                Data0(idx,:) = {maxSpeed_A,Speed_A,DistancetoCrosswaypoint_A,...
                                    maxSpeed_B,Speed_B,DistancetoCrosswaypoint_B,i,k};
                                idx = idx + 1;
                            end
                        end
                    elseif (obj.Vehicles(i).pathInfo.currentRoute == 43 || obj.Vehicles(i).pathInfo.currentRoute == 3) &&  obj.Vehicles(i).dynamics.speed ~= 0 %crossway point 4
                        for k = 1:10
                            if  (obj.Vehicles(k).pathInfo.currentRoute == 2 || obj.Vehicles(k).pathInfo.currentRoute == 42 )&& obj.Vehicles(k).dynamics.speed ~= 0
                                Speed_A = obj.Vehicles(i).dynamics.speed;
                                Position_A = obj.Vehicles(i).dynamics.position;
                                Speed_B = obj.Vehicles(k).dynamics.speed;
                                Position_B = obj.Vehicles(k).dynamics.position;
                                maxSpeed_A = obj.Vehicles(i).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_A = norm(Position_A - obj.Map.waypoints(4,:));
                                maxSpeed_B = obj.Vehicles(k).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_B = norm(Position_B - obj.Map.waypoints(4,:));
                                Data0(idx,:) = {maxSpeed_A,Speed_A,DistancetoCrosswaypoint_A,...
                                    maxSpeed_B,Speed_B,DistancetoCrosswaypoint_B,i,k};
                                idx = idx + 1;
                            end
                    ...
                    elseif obj.Vehicles(i).pathInfo.currentRoute == 75 &&  obj.Vehicles(i).dynamics.speed ~= 0 %crossway point 52
                        for k = 1:10
                            if obj.Vehicles(k).pathInfo.currentRoute == 24 &&  obj.Vehicles(k).dynamics.speed ~= 0
                                ...
                                Position_B = obj.Vehicles(k).dynamics.position;
                                maxSpeed_A = obj.Vehicles(i).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_A = norm(Position_A - obj.Map.waypoints(52,:));
                                maxSpeed_B = obj.Vehicles(k).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_B = norm(Position_B - obj.Map.waypoints(52,:));
                                Data0(idx,:) = {maxSpeed_A,Speed_A,DistancetoCrosswaypoint_A,...
                                    maxSpeed_B,Speed_B,DistancetoCrosswaypoint_B,i,k};
                                idx = idx + 1;
                            end
                    ...
                    elseif (obj.Vehicles(i).pathInfo.currentRoute == 16 || obj.Vehicles(i).pathInfo.currentRoute == 63) &&  obj.Vehicles(i).dynamics.speed ~= 0 %crossway point 36
                        for k = 1:10
                            if obj.Vehicles(k).pathInfo.currentRoute == 64 &&  obj.Vehicles(k).dynamics.speed ~= 0
                                ...
                                Position_B = obj.Vehicles(k).dynamics.position;
                                maxSpeed_A = obj.Vehicles(i).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_A = norm(Position_A - obj.Map.waypoints(36,:));
                                maxSpeed_B = obj.Vehicles(k).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_B = norm(Position_B - obj.Map.waypoints(36,:));
                                Data0(idx,:) = {maxSpeed_A,Speed_A,DistancetoCrosswaypoint_A,...
                                    maxSpeed_B,Speed_B,DistancetoCrosswaypoint_B,i,k};
                                idx = idx + 1;
                            end
                    ...
                    elseif (obj.Vehicles(i).pathInfo.currentRoute == 10 || obj.Vehicles(i).pathInfo.currentRoute == 55)&&  obj.Vehicles(i).dynamics.speed ~= 0 %crossway point 25
                        for k = 1:10
                            if obj.Vehicles(k).pathInfo.currentRoute == 66 &&  obj.Vehicles(k).dynamics.speed ~= 0
                                ...
                                Position_B = obj.Vehicles(k).dynamics.position;
                                maxSpeed_A = obj.Vehicles(i).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_A = norm(Position_A - obj.Map.waypoints(25,:));
                                maxSpeed_B = obj.Vehicles(k).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_B = norm(Position_B - obj.Map.waypoints(25,:));
                                Data0(idx,:) = {maxSpeed_A,Speed_A,DistancetoCrosswaypoint_A,...
                                    maxSpeed_B,Speed_B,DistancetoCrosswaypoint_B,i,k};
                                idx = idx + 1;
                            end
                    ...
                    elseif obj.Vehicles(i).pathInfo.currentRoute == 57 &&  obj.Vehicles(i).dynamics.speed ~= 0 %crossway point 23
                        for k = 1:10
                            if (obj.Vehicles(k).pathInfo.currentRoute == 9 || obj.Vehicles(k).pathInfo.currentRoute == 54)...
                                ...
                                Position_B = obj.Vehicles(k).dynamics.position;
                                maxSpeed_A = obj.Vehicles(i).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_A = norm(Position_A - obj.Map.waypoints(23,:));
                                maxSpeed_B = obj.Vehicles(k).dynamics.maxSpeed;
                                DistancetoCrosswaypoint_B = norm(Position_B - obj.Map.waypoints(23,:));
                                Data0(idx,:) = {maxSpeed_A,Speed_A,DistancetoCrosswaypoint_A,...
                                    maxSpeed_B,Speed_B,DistancetoCrosswaypoint_B,i,k};
                                idx = idx + 1;
                            end
                ...
                on = [];
                off = [];
                v = [2, 2, 2, 2, 2, 2, 2, 2, 2, 2];  % 2 means doesn't predict
                if H ~= 0;
                    [Predict,~] = predict(Version3_2.ClassificationEnsemble,Data0(:,1:8));
                    x = 1;
                    y= (1:10);
                    for z = 1:H
                        if v(Data0.A(z)) ~= 1
