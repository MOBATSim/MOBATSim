    ...
    methods
        ...
        function formattedRoute = getRouteDefinitionfromRouteID(obj, routeID)
            ...
            if routeID>length(obj.connections.circle)
                routeID = routeID - length(obj.connections.circle); % Some transformation to correct the error
        ...
        % Turn off useless properties for performance optimization
            ...
            view(2)
            hold on
            obj.plots.Vehicles = scatter([],[],300,'filled', 'MarkerFaceColor',[0.7 0 0],'MarkerEdgeColor','k'); % Size of the vehicle bubbles            
            hold off
