...
=======
       %startingPoints =    [84 86 29 18 53 52 64 57 15 63];
       %destinationPoints = [83 51 78 1  3  27 42 25 76 46];
       %maxSpeeds = [7 20 8 7 14 20 10 12 10 10];
        
        %% collision test scenario (vehicle 2 crashes in vehicle 7)
        startingPoints    = [84 34 29 18 53 52 35 57 15 63];
        destinationPoints = [83 12 78 1  3  27 12 25 76 46];
        
        maxSpeeds         = [7 20 8 7 14 20 10 12 10 10];
>>>>>>> b06f26d... new scenario 'collision test' added
